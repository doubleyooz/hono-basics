...
import type { CreateRoute, GetOneRoute, ListRoute, PatchRoute, RemoveRoute } from "./report.route.js";
...
const remove: AppRouterHandler<RemoveRoute> = async (c) => {
  ...
  return c.json({ message: "Report deleted successfully" }, HttpStatusCodes.OK);
};
